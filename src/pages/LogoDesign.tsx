          ...
          <div className="container mx-auto px-6 py-24">
            <div className="max-w-4xl">
              <div className="flex items-center text-sm mb-8">
                ...
                <span className="mx-2">›</span>
                <span className="text-blue-300">Logo & Brand Identity Designing</span>
              </div>

              <h1 className="text-5xl md:text-6xl font-bold mb-8">
                Logo & <span className="text-blue-400">brand identity</span> designing services
              </h1>

              <p className="text-lg md:text-xl mb-12 max-w-3xl">
                At Oditech Global, we create memorable brand identities that tell your story and connect with your audience. Our expert designers craft logos and comprehensive brand guidelines that establish a strong visual presence across all platforms.
              </p>
    ...
    <RevealOnScroll>
      <section id='benefits' className="py-16 px-4 max-w-6xl mx-auto text-center">
        <h1 className="text-5xl font-bold mb-2">
          ...
          <span className="text-blue-500">brand identity design?</span>
        </h1>

        <p className="text-lg mt-8 mb-16 max-w-4xl mx-auto text-gray-700">
          Our creative team specializes in developing cohesive brand identities that resonate with your target audience. We combine artistic vision with strategic thinking to create brands that stand out and drive business growth.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-6">
            ...
            <p>Unique and innovative designs that capture your brand's essence.</p>
          </div>
          ...
          <div className="p-6">
            ...
            <p>Designs based on market research and brand positioning strategies.</p>
          </div>
          ...
          <div className="p-6">
            ...
            <p>Brand elements that work seamlessly across all marketing materials.</p>
          </div>
        </div>
      </section>
    </RevealOnScroll>
  ...
  const services = [
    {
      ...
      content: {
        ...
        description: "Custom logo designs that represent your brand's personality and values.",
        items: [
          "Concept development",
    ...
    },
    {
      ...
      content: {
        ...
        description: "Comprehensive brand identity systems including logos, colors, and guidelines.",
        items: [
          "Brand strategy",
    ...
    },
    {
      ...
      content: {
        ...
        description: "Eye-catching packaging designs that enhance product appeal and shelf presence.",
        items: [
          "Package design",
          "Label creation",
          "Material selection",
        ...
        link: "Packaging design services ›",
...
const FeaturesSection = () => {
  const features = [
    ...
    {
      icon: <VersatileIcon />,
      title: 'Versatile File Formats',
      description: 'Deliverables in all necessary formats for print, web, and digital applications.'
    },
    {
      icon: <BrandIconFeature />,
      title: 'Brand Consistency',
      description: 'Design systems that maintain brand consistency across all touchpoints.'
    },
    {
      icon: <ResearchIcon />,
      title: 'Market Research',
      description: 'Designs informed by market research and competitor analysis.'
    },
    {
      icon: <TypographyIcon />,
      title: 'Typography Expertise',
      description: 'Careful selection of fonts and typography that enhance brand personality.'
    },
    {
      icon: <ColorIcon />,
      title: 'Color Psychology',
      description: 'Strategic use of colors that evoke desired emotions and associations.'
    }
  ];
  ...
  return (
    ...
    <section id='features' className="max-w-6xl mx-auto px-4 py-12">
      <h2 className="text-3xl font-bold text-center mb-12">
        Our brand design <span className="text-blue-500">features</span>
      </h2>
  ...
  const processes = [
    {
      ...
      description: "We start by understanding your business, target audience, and brand goals through in-depth research."
    },
    {
      step: "02",
      title: "Concept Development",
      description: "Our designers create multiple logo concepts based on the research and your brand requirements."
    },
    {
      step: "03",
      title: "Design Refinement",
      description: "We refine the selected concepts through multiple iterations based on your feedback."
    },
    {
      step: "04",
      title: "Final Delivery",
      description: "You receive final logo files in all necessary formats along with brand guidelines."
    }
  ];
  ...
  const faqs = [
    {
      ...
      answer: (
        <>
          <p>We provide 3-5 initial logo concepts to choose from. Each concept includes variations and we offer unlimited revisions until you're completely satisfied.</p>
        </>
      )
    },
    {
      ...
      answer: (
        <>
          <p>We deliver logos in all necessary formats including AI, EPS, PDF, PNG, JPG, and SVG for both print and digital use.</p>
        </>
      )
    },
    {
      ...
      answer: (
        <>
          <p>Yes, we create comprehensive brand guidelines that include logo usage rules, color palettes, typography, and application examples.</p>
        </>
      )
    },
    {
      ...
      answer: (
        <>
          <p>The typical timeline is 2-4 weeks from concept to final delivery, depending on the complexity and number of revisions needed.</p>
        </>
      )
    },
    {
      ...
      answer: (
        <>
          <p>Absolutely! We can modernize your existing logo while maintaining brand recognition or create an entirely new identity if needed.</p>
        </>
      )
    }
  ];
...
const LogoDesign = () => {
  ...
  const contentsMenu = [
    ...
    { title: 'Design Process', id: 'process' },
    { title: 'FAQ', id: 'faq' }
  ];
