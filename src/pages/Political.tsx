          ...
          <div className="container mx-auto px-6 py-24">
            ...
            <div className="max-w-4xl">
              <div className="flex items-center text-sm mb-8">
                ...
                <span className="mx-2">›</span>
                <span className="text-blue-300">Political Campaigns & Social Media-PR Management</span>
              </div>

              {/* Hero Content */}
              <h1 className="text-5xl md:text-6xl font-bold mb-8">
                Political Campaigns & <span className="text-blue-400">Social Media-PR Management</span> services
              </h1>

              <p className="text-lg md:text-xl mb-12 max-w-3xl">
                At Oditech Global, we specialize in comprehensive political campaign management and strategic social media-PR services. Our expert team helps political figures and organizations navigate the complex digital landscape to build strong public presence and influence.
              </p>
    ...
    <RevealOnScroll>
      <section id='benefits' className="py-16 px-4 max-w-6xl mx-auto text-center">
        <h1 className="text-5xl font-bold mb-2">
          ...
          <span className="text-blue-500">Political Campaigns & Social Media-PR?</span>
        </h1>

        <p className="text-lg mt-8 mb-16 max-w-4xl mx-auto text-gray-700">
          Our specialized team understands the unique challenges of political communication. We combine strategic PR expertise with cutting-edge social media management to help political figures and organizations effectively reach and engage their constituencies.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-6">
            ...
            <p>Crafting compelling narratives that resonate with target audiences and drive voter engagement.</p>
          </div>
          ...
          <div className="p-6">
            ...
            <p>Rapid response strategies to address controversies and maintain public trust.</p>
          </div>
          ...
          <div className="p-6">
            ...
            <p>Leveraging social media platforms to build communities and foster political participation.</p>
          </div>
        </div>
      </section>
    </RevealOnScroll>
  ...
  const services = [
    {
      ...
      content: {
        title: "Campaign Management",
        description: "Comprehensive campaign strategy and execution from planning to election day.",
        items: [
        ...
        link: "Campaign services ›",
        image: "/campaign-mgmt.webp"
      }
    },
    {
      id: "social",
      ...
      content: {
        title: "Social Media Strategy",
        description: "Strategic social media management tailored for political campaigns and organizations.",
        items: [
    ...
    },
    {
      ...
      content: {
        title: "PR & Communications",
        description: "Professional PR services including media relations and stakeholder communications.",
        items: [
    ...
    <section id='services' className="bg-blue-950 min-h-screen text-white py-16 px-4 md:px-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-2">
          Political Campaigns & Social Media-PR Management
        </h1>
...
const PRIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" className="w-16 h-16" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    <path d="M32 14C24.3 14 18 20.3 18 28C18 32.4 20.1 36.3 23.4 38.9L21.6 46.4L29.1 44.6C30.4 44.8 31.7 45 33 45C40.7 45 47 38.7 47 31C47 23.3 40.7 17 33 17" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
  ...
  const features = [
    {
      ...
      description: 'Developing clear, consistent messaging that resonates with voters and stakeholders.'
    },
    {
      icon: <AnalyticsIcon />,
      title: 'Campaign Analytics',
      description: 'Data-driven insights to optimize campaign performance and voter engagement.'
    },
    {
      icon: <CrisisIcon />,
      title: 'Crisis Management',
      description: 'Rapid response protocols for managing political controversies and media scrutiny.'
    },
    {
      icon: <EngagementIcon />,
      title: 'Voter Engagement',
      description: 'Innovative strategies to mobilize supporters and increase voter turnout.'
    },
    {
      icon: <MediaIcon />,
      title: 'Media Relations',
      description: 'Building relationships with journalists and managing earned media coverage.'
    },
    {
      icon: <DigitalIcon />,
      title: 'Digital Strategy',
      description: 'Comprehensive digital presence across social media and online platforms.'
    }
  ];
  ...
  return (
    ...
    <section id='features' className="max-w-6xl mx-auto px-4 py-12">
      <h2 className="text-3xl font-bold text-center mb-12">
        Our political campaign & PR <span className="text-blue-500">features</span>
      </h2>
...
const MediaIcon = () => (
  <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="8" y="12" width="44" height="36" rx="4" fill="#E6F4FF" stroke="#0080FF" strokeWidth="2" />
    <circle cx="30" cy="24" r="6" fill="#0080FF" fillOpacity="0.3" />
    <path d="M20 36h20" stroke="#0080FF" strokeWidth="2" strokeLinecap="round" />
    <circle cx="24" cy="40" r="2" fill="#0080FF" />
    <circle cx="30" cy="40" r="2" fill="#0080FF" />
    <circle cx="36" cy="40" r="2" fill="#0080FF" />
  </svg>
);
...
const DigitalIcon = () => (
  <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="8" y="12" width="44" height="36" rx="4" fill="#E6F4FF" stroke="#0080FF" strokeWidth="2" />
    <rect x="16" y="20" width="8" height="8" rx="1" fill="#0080FF" fillOpacity="0.3" />
    <rect x="26" y="20" width="8" height="8" rx="1" fill="#0080FF" fillOpacity="0.3" />
    <rect x="36" y="20" width="8" height="8" rx="1" fill="#0080FF" fillOpacity="0.3" />
    <rect x="16" y="30" width="8" height="4" rx="1" fill="#0080FF" fillOpacity="0.3" />
    <rect x="26" y="30" width="8" height="4" rx="1" fill="#0080FF" fillOpacity="0.3" />
    <rect x="36" y="30" width="8" height="4" rx="1" fill="#0080FF" fillOpacity="0.3" />
  </svg>
);
...
const FAQSection = () => {
  const faqs = [
    {
      question: 'How do you handle sensitive political information?',
      answer: (
        <>
          <p>We maintain strict confidentiality protocols and comply with all relevant data protection regulations. All team members sign NDAs and follow secure communication practices.</p>
        </>
      )
    },
    {
      question: 'What is your experience with political campaigns?',
      answer: (
        <>
          <p>Our team has successfully managed campaigns at local, state, and national levels, working with candidates, parties, and political organizations across various jurisdictions.</p>
        </>
      )
    },
    {
      ...
      answer: (
        <>
          <p>We track voter engagement, media coverage, social media metrics, polling data, and election results to provide comprehensive campaign performance analysis.</p>
        </>
      )
    },
    {
      question: 'Can you handle multilingual campaigns?',
      answer: (
        <>
          <p>Yes, we have experience managing multilingual campaigns and can provide translation services and culturally appropriate messaging for diverse constituencies.</p>
        </>
      )
    },
    {
      question: 'What is your crisis response time?',
      answer: (
        <>
          <p>We provide 24/7 crisis monitoring and can initiate response strategies within 30 minutes of detecting a potential issue, with full crisis management teams mobilized within 2 hours.</p>
        </>
      )
    }
  ];
